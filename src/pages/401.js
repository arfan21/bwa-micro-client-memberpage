...
export const Unauthenticated = ({ fallbackUrl, fallbackText, external }) => {
    return (
        <section className="h-screen flex flex-col items-center">
            <img
                src={`${process.env.PUBLIC_URL}/assets/images/unauthenticated.png`}
                alt="you are not suppose here, please login"
            />
